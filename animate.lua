...
local animNames = { 
	idle = 	{	
				{ id = "http://www.roblox.com/asset/?id=", weight = 9 },
				{ id = "http://www.roblox.com/asset/?id=", weight = 1 }
			},
	walk = 	{ 	
...
function onRunning(speed)
	if speed > 0.01 then
		...
		if currentAnimInstance and currentAnimInstance.AnimationId == "http://www.roblox.com/asset/?id=" then
